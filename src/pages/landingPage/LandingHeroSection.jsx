...
function LandingHeroSection() {
    ...
    return (
        <div className="conteiner" data-aos="fade-right"
        data-aos-offset="300"
        data-aos-easing="ease-in-sine" >
            {/* hero */}
            <div className="heroSection">
                <div className='praHero'>
                    <h1>
                        Say goodbye to mundane tasks and welcome the convenience and
                        intelligence of the future home!
                    </h1>
                    <p>
                        Enjoy a smart home experience that meets all your needs and provides you
                        with comfort, security, and intelligence. Imagine being able to turn on
                        the air conditioner before you get home, turn off the lights when you
                        leave the room, or monitor your home remotely using smart surveillance
                        cameras.
                    </p>
